...
{
    public partial class Usuarios : PageCrud<UsuarioBLL>
    {
        ...
        {
            ObjBLL.Get(PkValue);
            this.txtCodigo.Text = Convert.ToString(ObjBLL.ObjEF.id_pessoa);
            ...
            this.cDdlSistema1.Id_sistema = ObjBLL.ObjEF.id_sistema;            
         }

        protected override void Set()
        {
            ObjBLL.ObjEF.id_pessoa = Convert.ToInt32(this.txtCodigo.Text);
            ...
            ObjBLL.ObjEF.id_sistema = this.cDdlSistema1.Id_sistema;
        }
