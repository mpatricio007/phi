<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="FormaPagtos.aspx.cs" Inherits="Medusa.Sistemas.Comum.FormaPagtos" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_forma">código</asp:ListItem>
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_forma" HeaderText="código" 
                                SortExpression="id_forma" >
                    ...
                    <table class="cadastro">
                        ...
                        <tr>
                            <td class="esquerdo">
                                reuqer nº:</td>
                            <td class="direito">
                                <asp:CheckBox ID="ckRequerNum" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
