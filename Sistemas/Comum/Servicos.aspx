<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="Servicos.aspx.cs" Inherits="Medusa.Sistemas.Comum.Servicos" %>
               ...
               <div class="FilterName">
                ...
                <div class="pesquisar">
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOptions" runat="server" CausesValidation="True" 
                        ...
                        <asp:ListItem Value="id_servico">código</asp:ListItem>                        
                ...
                <asp:Panel ID="panelGrid" runat="server">
                    ...
                    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_servico" HeaderText="código" 
                                SortExpression="id_servico" >
