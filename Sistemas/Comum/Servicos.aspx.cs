...
{
    public partial class Servicos : PageCrud<ServicoBLL>
    {
        protected override void Page_Load(object sender, EventArgs e)
        {
            // chave primária da tabela
            PRIMARY_KEY = "id_servico";
        ...
        {
            ObjBLL.Get(PkValue);
            this.txtCodigo.Text = Convert.ToString(ObjBLL.ObjEF.id_servico);            
        ...
        {
            ObjBLL.ObjEF.id_servico = Convert.ToInt32(this.txtCodigo.Text);            
