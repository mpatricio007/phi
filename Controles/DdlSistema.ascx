<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlSistema.ascx.cs" Inherits="Medusa.Controles.DdlSistema" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="nome" 
                    DataValueField="id_sistema" AppendDataBoundItems="True">
                </asp:DropDownList>
...
<asp:CompareValidator ID="cv" runat="server" 
    ErrorMessage="selecione um perfil..." ForeColor="Red" Operator="NotEqual" 
