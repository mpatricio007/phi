<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DdlCidade.ascx.cs" Inherits="Medusa.Controles.DdlCidade" %>
                <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                <asp:DropDownList ID="lista" runat="server" DataTextField="cidade" 
                    DataValueField="cidade" AppendDataBoundItems="True">
                </asp:DropDownList>
