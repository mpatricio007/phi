<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="RelatorioClientes.aspx.cs" Inherits="Medusa.Relatorios.RelatorioClientes" %>
          ...
          <table class="cadastro">
                        ...
                        <tr>
                            ...
                            <td class="direito" style="height: 23px">
                                <cddlPlano:cDdlPlano ID="cDdlPlano1" runat="server" ValidationGroup="11111" />
                            </td>
                        </tr>
                        <tr>
                            <td class="esquerdo">
